...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::custom_command::CustomCommand::decl(),
        db::models::custom_command::CreateCustomCommand::decl(),
        db::models::custom_command::UpdateCustomCommand::decl(),
        ...
        services::services::config::TeamsConfig::decl(),
        git::GitBranch::decl(),
